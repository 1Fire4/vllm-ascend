...
class TestAscendSFAImpl(TestBase):
    ...
    @patch("torch_npu.atb.npu_ring_sfa")
    ...
    @patch("vllm_ascend.attention.sfa_v1.AscendSFAImpl._v_up_proj")
    ...
    @patch("vllm_ascend.attention.sfa_v1.maybe_npu_prefetch")
    def test_sfa_preprocess(self, magic_npu_fetch,
    ...
    @patch("vllm_ascend.attention.sfa_v1.get_multistream_comm_context")
    @patch("torch_npu.npu_fused_infer_attention_score")
